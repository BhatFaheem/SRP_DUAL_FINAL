#
# OMNeT++/OMNEST Makefile for SRP_DUAL_FINAL
#
# This file was generated with the command:
#  opp_makemake -f --deep -O out -KINET_PROJ=/home/faheem/Downloads/inet4.5 -DINET_IMPORT -I. -I$$\(INET_PROJ\)/src -L$$\(INET_PROJ\)/src -lssl -lcrypto -lINET$$\(D\) -d src
#

# Name of target to be created (-o option)
TARGET_DIR = .
TARGET_NAME = SRP_DUAL_FINAL$(D)
...
LIBS = $(LDFLAG_LIBPATH)$(INET_PROJ)/src  -lssl -lcrypto -lINET$(D)
...
INET_PROJ=/home/faheem/Downloads/inet4.5
